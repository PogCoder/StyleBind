...
class OutfitPageItemWidget extends StatelessWidget {
  OutfitPageItemWidget(this.outfitPageItemModelObj);

  OutfitPageItemModel outfitPageItemModelObj;

  var controller = Get.find<OutfitPageController>();
